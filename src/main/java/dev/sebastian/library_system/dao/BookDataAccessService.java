...
public class BookDataAccessService implements BookDAO
{
    ...
    private final String SQL_SELECT_BOOK_BY_ID = "SELECT book_id, title, author FROM Book WHERE book_id = ?";
    private final String SQL_SELECT_ALL_BOOKS = "SELECT book_id, title, author FROM Book";
    ...
    {
        // Insert jdbcTemplate update statement...
